          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                A Senior UI/UX Designer with 5+ years of experience crafting user-centered digital experiences for web and mobile applications. I specialize in product design, design systems, UX research, wireframing, prototyping, and responsive interfaces. My goal is to create intuitive, scalable, and impactful products that solve real user problems.
                </p>
                ...
                <div className="grid grid-cols-3 py-10 xl:py-16 gap-5 border-b border-mistGray">
                  {[
                    ...
                    { count: "200+", label: "Project Completed" },
                  ].map((item, i) => (
                    <div key={i}>
                      <h3>{item.count}</h3>
